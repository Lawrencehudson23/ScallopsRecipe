...
<body>
  <nav class="white" role="navigation">
    <div class="nav-wrapper container">
      <a id="logo-container" href="/" class="brand-logo">Bestrecipes<i class="material-icons">face</i></a>
  ...
  <div id="index-banner" class="parallax-container">
    <div class="section no-pad-bot">
      <div class="container recipe-display-box">
        <br><br>
        		<!-- ************************************************** -->
        <h1 class="header center teal-text text-lighten-2">${r.name}</h1>
        <div class="row center">
             <img style="max-width:100%; max-height:100%" src="https://tse1.mm.bing.net/th?id=OIP.64vXNk6FRg6TzVCW7u2zLAHaFj&pid=Api" alt="image of a pasta dish">
            <h6 class="center">Posted By: ${r.creator.username}</h6>
            <div style="border-style:solid;">
 				<p class="light">Ingredients:</p>
 					<c:forTokens items="${r.ingredients}" delims="," var="ingredient">
 						<p class="ingredients-list"><c:out value="${ingredient}"/>
 					</c:forTokens>
 			</div>
            <p class="light">Directions: ${r.directions}</p>
      ...
      <div class="row">
        ...
        <div class="col s12 m4">
          <div class="icon-block">
            ...
            <h5 class="center">Easy to work witChocolate Chocolate Chip Cookies</h5>
  ...
  <div class="parallax-container valign-wrapper">
    ...
    <div class="parallax"><img src="../img/b4.jpg" alt="Unsplashed background img 3"></div>
  </div>
    ...
    <div class="container">
      <div class="row">
        <div class="col l6 s12">
          ...
          <p class="grey-text text-lighten-4">We are a team of scallops working on this project like it's our full time job. Any amount would help support and continue development on this project and is greatly appreciated.</p>
